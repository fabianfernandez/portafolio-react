        ...
        <Row gutter={[20, 20]}>
          <Col span={8} style={{ alignItems: "stretch", display: "flex" }}>
            <Row gutter={[10, 10]}>
              <Card>
                ...
                <Typography>
                  ...
                  <Paragraph>
                    ...
                    principalmente en el desarrollo software. Tengo experiencia
                    en el uso de tecnologías tales como: Python, JavaScript,
                    SQL, React, Django, React Native, Docker y otras. Además, he
                    trabajado en proyectos que utilizaron patrones como API
                    REST, Serverless, MVC, POO y ORM. Estoy interesado
                    especialmente en el desarrollo full-stack y siempre
                    dispuesto a aprender las nuevas tecnologías requeridas por
                    la industria.
                  </Paragraph>
                </Typography>
              </Card>
              <Card style={{ flex: 1 }}>
                <Typography>
                  <Title level={3}>Habilidades y Tecnologías </Title>
          ...
          <Col span={16} style={{ alignItems: "stretch", display: "flex" }}>
            <Card>
              <Typography>
                ...
                de sistemas de distintos proyectos de la empresa Unholster S.A.
                El proyecto en el cual trabajé principalmente fue en el
                desarrollo de una aplicación web que apoyaba la gestión de
                instrucciones de pago para una empresa financiera.
                <br />
                Algunas de mis tareas en específicas fueron:
                <ul>
                  <li>
                    Desarrollar vistas del software basadas en maquetas
                    propuestas por el equipo UX/UI de la empresa utilizando
                  ...
                  <li>
                    Asistir y coordinar reuniones diarias con miembros del
                    equipo para informar avances, problemas y dudas relacionadas
                ...
                <ul>
                  ...
                  <li>
                    Aprender un conjunto de tecnologías que me permite
                    desarrollar mi trabajo como desarrollador Full-Stack.
                  </li>
                  <li>Aplicar en la práctica la metodología Scrum.</li>
                </ul>
                <Title level={5}>
                  Desarrollador móvil | Memoria UTFSM | Agosto 2022 - Agosto
                  2023
                </Title>
                Desarrollo de una aplicación móvil Android para optar al grado
                de Ingeniero civil en Informática. El software desarrollado
                buscaba apoyar en la gestión del aprendizaje autorregulado y
                disminuir la procastinación de los estudiantes de primer año de
                ingeniería civil informática de la Universidad Técnica Federico
                Santa María.
                <br />
                En esta experiencia aprendí lo siguiente:
                <ul>
                  <li>
                    Crear una aplicación móvil desde cero utilizando React
                    Native y Expo.
                  </li>
                  <li>
                    Desarrollar un sistema de navegación y ruteo utilizando
                    React Navigation.
                  </li>
                  <li>
                    Construir vistas utilizando conceptos básicos de React
                    Native y la librería React Native Elements.
                  </li>
                  <li>
                    Administrar archivos asociados a la aplicación utlizando
                    Expo SDK.
                  </li>
                  <li>
